...
<table id="dg" title="产品管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:10"
       url="${pageContext.request.contextPath}/listProduct"
       toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="10%" align="center" hidden="true">编号</th>
        <th field="name" width="150" align="center">产品名称</th>
        <th field="pic" width="300" align="center" formatter="formatProPic">缩略图</th>
        <th field="desc" width="150" align="center">产品简介</th>
    </tr>
    </thead>
</table>
<div id="tb">
        ...
        <div style="padding-top:50px;  float:left; width:95%; padding-left:30px;">
            <div id="i_do_wrap">
                ...
                <div class="i_do_div rel">
                    <p class="i_do_tle r_txt abs font14">产品名称</p>
...
<script type="text/javascript">
    ...
    function savePicture() {
        ...
        var data = {"id": id, "name": title,"desc":desc, "pic": path};
        $.ajax({
            type: method,//方法类型
            dataType: "json",//预期服务器返回的数据类型
            url: url,//url
    ...
    function openPictureModifyDialog() {
        ...
        $('#picture').append(html);
        var imghtml =
            '<img src="images/back.jpg" width="110" height="110" id="img11" style="display:none;"/><input type="text" id="input11" name="path" value="' + row.pic + '" style="display:none;" />';
        $('#pic11').append(imghtml);
