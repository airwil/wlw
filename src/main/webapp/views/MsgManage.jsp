...
<table id="dg" title="技术交流" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true"
       url="${pageContext.request.contextPath}/listMessageMap" toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="10%" align="center" hidden="true">编号</th>
        <th field="content" width="200" align="center">内容</th>
        <th field="ip" width="200" align="center">IP</th>
...
<script type="text/javascript">
    ...
    function formatHref(val, row) {
        return "<a href='${pageContext.request.contextPath}/portal/jsjl/html/jie/detail.html?id=" + row.id + "' target='_blank'>查看详情</a>";
    }
