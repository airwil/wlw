...
<head>
    ...
    <script type="text/javascript">
        var url = "${pageContext.request.contextPath}/updateContact";
        var method;
        ...
        function saveContact() {
            ...
            var qq=$("#qq").val();
            var id = $("#id").val();
            var data = {"id": id, "address": address,"tel":tel, "qq": qq}
            $.ajax({
                type: method,//方法类型
                dataType: "json",//预期服务器返回的数据类型
                url: url,//url
        ...
        function openUserModifyDialog() {
            ...
            $("#dlg").dialog("open").dialog("setTitle", "编辑联系信息");
            $('#fm').form('load', row);
            $("#id").val(row.id);
            method = "PUT";
        }
...
<table id="dg" title="联系我们" class="easyui-datagrid" fitColumns="true"
    ...
    <tr>
        ...
        <th field="qq" width="100" align="center">邮箱</th>
    </tr>
    </thead>
</table>
<div id="tb">
...
<div id="dlg-buttons">
    <a href="javascript:saveContact()" class="easyui-linkbutton"
