...
<table id="dg" title="中心介绍" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true"
       url="${pageContext.request.contextPath}/selectIntroduct" toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="10%" align="center" hidden="true">编号</th>
        <th field="content" width="1000px" align="left">内容</th>
...
<script type="text/javascript">
    ...
    function formatHref(val, row) {
        return "<a href='${pageContext.request.contextPath}/introduct.html?id=" + row.id + "' target='_blank'>查看详情</a>";
    }
